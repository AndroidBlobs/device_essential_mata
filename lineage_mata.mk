...
PRODUCT_BUILD_PROP_OVERRIDES += PRIVATE_BUILD_DESC="mata-user 10 QP1A.191005.014 478 release-keys"

# Set BUILD_FINGERPRINT variable to be picked up by both system and vendor build.prop
BUILD_FINGERPRINT := essential/mata/mata:10/QP1A.191005.014/478:user/test-keys
